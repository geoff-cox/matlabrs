...
function [maze, player] = HW4_initialize_game_v2(height, width)
...
function location = HW4_select_random_location(maze, reserved_locations)
    ...
    for r = 1:height(reserved_locations)
        reserved(reserved_locations(r,1), reserved_locations(r,2)) = true;
    end
...
function player = HW4_move_player_v2(maze, player, direction)
...
function HW4_dark_cavern_v2()

    % Initialize the game
    [maze, player] = HW4_initialize_game_v2(11,13);
    ...
    while true
        ...
        HW4_display_maze_v2(maze, player)
        ...
        % Move the player
        player = HW4_move_player_v2(maze, player, direction);
