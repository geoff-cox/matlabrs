...
%% Test 1 -----------------------------------------------------------------
close all
HW7P2_display_game_board_lastname(guess_boxes1,keyboard1)  % Comment out the close 
                                                      % all command in the
                                                      % display_game_board
                                                      % function!
attempt_num = 3;
...
[guess_boxes1,keyboard1] ...
    = HW7P4_update_colors_in_structs_lastname(guess_boxes1, keyboard1, ...
                                              attempt_num, colors1);
HW7P2_display_game_board_lastname(guess_boxes1,keyboard1)
