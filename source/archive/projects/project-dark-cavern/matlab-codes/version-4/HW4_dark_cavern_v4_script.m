...
function HW4_dark_cavern_v4()wdd

    % Initialize the game
    [maze, player] = HW4_initialize_game_v4(11,13);
    ...
    while true
        ...
        HW4_display_maze_v4(maze, player)
        ...
        % Move the player
        player = HW4_move_player_v4(maze, player, direction);
