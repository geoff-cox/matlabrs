...
[guess_boxes, color_boxes] = HW6P7_create_guess_boxes_structure();
...
%----------------------------------------------------------------------
HW7P2_display_game_board_Key(guess_boxes, color_boxes, true);
...
while ~is_game_over
    ...
    for col = 1:5
        ...
        guessed_letter = HW7P3_get_the_letter_Key(x,y,color_boxes);
    ...
    if ~is_a_word
        ...
        HW7P2_display_game_board_Key(guess_boxes, color_boxes, false);
        ...
        [guess_boxes,color_boxes] = HW7P4_update_colors_in_structs_Key( ...
                                                guess_boxes, ...
                                                color_boxes, ...
                                                current_attempt_num, ...
